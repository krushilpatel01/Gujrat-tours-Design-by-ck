...
(1, 'cruise-01', 'lonawala', 'Sikkim', 2147483647, 'CordeliaCruises_SRP1.jpg', 'ck'),
(4, 'demo-01', 'jetpur', 'Laskha Dweep ', 938348, 'GettyImages-1432005421-5c0bc8d84cedfd0001fa5acb.jpg', 'ck');
...
INSERT INTO `user` (`id`, `image`, `name`, `email`, `password`, `confirm_pw`, `user_type`, `auther`) VALUES
(16, '', 'krushil', 'krushilchabhadiya600@gmail.com', '9e5bd77cdf6c58281d21fce42d8d48d1', '', 'User', ''),
(31, '', 'demo', 'demo@gmail.com', 'f702c1502be8e55f4208d69419f50d0a', '', 'Admin', ''),
